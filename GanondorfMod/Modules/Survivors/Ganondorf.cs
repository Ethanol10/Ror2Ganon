...
namespace GanondorfMod.Modules.Survivors
{
    internal class Ganondorf : SurvivorBase
    {
        ...
        internal override void InitializeSkins()
        {
            ...
            #region MasterySkin
            Material masteryMat = Modules.Assets.CreateMaterial("ganonTex04", 75f, Color.white, 1.0f);
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        new ItemDisplayRule
                        {
                            ...
                            childName = "HandL",
                            localPos = new Vector3(-0.01095F, -0.00776F, 0.00205F),
                            localAngles = new Vector3(9.98726F, 288.1167F, 7.67295F),
