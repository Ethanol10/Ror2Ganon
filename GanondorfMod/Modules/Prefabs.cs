...
namespace GanondorfMod.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            string fullNameString = GanondorfPlugin.developerPrefix + "_" + namePrefix + "_BODY_NAME";
            string fullDescString = GanondorfPlugin.developerPrefix + "_" + namePrefix + "_BODY_DESCRIPTION";
            string fullOutroString = GanondorfPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FLAVOR";
            string fullFailureString = GanondorfPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
        ...
        {
            GanondorfPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            GanondorfPlugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            GanondorfPlugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
